...
- Create file: `doc/feature-database-migration-YYYY-MM-DD.md`
- Document: migration details (name, purpose, changes), schema changes, data transformations
- Include migration status, rollback procedures, and any important notes
